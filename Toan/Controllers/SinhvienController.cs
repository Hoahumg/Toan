...
using MvcMovie.Data;
using Toan.Models;
using Toan.Models.Process;

namespace Toan.Controllers
{
    public class SinhvienController : Controller
    {
       ...
       // GET: Sinhvien/Create
        ...
        {
            var IDdautien = "SV1";
            var countAnh = _context.Sinhvien.Count();
            if (countAnh > 0)
            {
                var Masinhvien = _context.Sinhvien.OrderByDescending(m => m.Masinhvien).First().Masinhvien;
